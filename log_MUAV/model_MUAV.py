...
def get_model(num_dim_x, num_dim_control, w_lb, use_cuda=False):
    ...
    model_Wbot = torch.nn.Sequential(
        ...
        torch.nn.Tanh(),
        torch.nn.Linear(256, (num_dim_x-num_dim_control) ** 2, bias=False))
    ...
    model_W = torch.nn.Sequential(
        ...
        torch.nn.Linear(128, 256, bias=True),
        torch.nn.Tanh(),
        torch.nn.Linear(256, num_dim_x * num_dim_x, bias=False))
    ...
    model_u_w1 = torch.nn.Sequential(
        ...
        torch.nn.Tanh(),
        torch.nn.Linear(512, c*num_dim_x, bias=True))
    ...
    model_u_w2 = torch.nn.Sequential(
        ...
        torch.nn.Linear(256, 512, bias=True),
        torch.nn.Tanh(),
        torch.nn.Linear(512, num_dim_control*c, bias=True))
