...
import importlib
from utils_test import EulerIntegrate, RK4
import time
...
#f, B, _, num_dim_x, num_dim_control, num_dim_noise = get_system_wrapper(system)
...
if __name__ == '__main__':
    ...
    xstar, _ = RK4(None, f, B, None, ustar, xstar_0, time_bound, time_step, with_tracking=False)
    ...
    for _ in range(nTraj):
        ...
        x, u = RK4(controller, f, B, xstar, ustar, xinit, time_bound, time_step, with_tracking=True, sigma=sigma)
        x_closed.append(x)
