...
save_plot_path = os.path.join('results_fieldformer/plots', trajectory_type)  # Path to save the plot image, e.g., 'results/plots/3D_path.png'; to show the plot instead, set to None
save_csv_path = os.path.join('results_fieldformer/csvs', trajectory_type)  # Path to save the csv files; disable with None
